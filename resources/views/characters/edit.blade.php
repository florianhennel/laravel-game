    ...
    <div class="flex flex-col items-center p-2 mb-6 mx-auto bg-white dark:bg-gray-800 rounded-lg w-1/3">
        ...
        <form method="post" action="{{ route('characters.update', ['character' => $character]) }}" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $character->name)" required
            ...
            <div>
                ...
                <x-number-input id="strength" name="strength" type="number" class="mt-1 block w-full" :value="old('strength', $character->strength)"
                    required autofocus autocomplete="strength" />
                <x-input-error class="mt-2" :messages="$errors->get('strength')" />
            </div>
            <div>
                <x-input-label for="accuracy" :value="__('Accuracy')" />
                <x-number-input id="accuracy" name="accuracy" type="number" class="mt-1 block w-full" :value="old('accuracy', $character->accuracy)"
                    required autofocus autocomplete="accuracy" />
                <x-input-error class="mt-2" :messages="$errors->get('accuracy')" />
            </div>
            <div>
                <x-input-label for="magic" :value="__('Magic')" />
                <x-number-input id="magic" name="magic" type="number" class="mt-1 block w-full" :value="old('magic', $character->magic)"
                    required autofocus autocomplete="magic" />
